export class BaseScanAPI {
    ...
    public static async getLockUNCXuniv2(currentBlock: number, startBlock: number) {
        const urlLockUNCX = `https://api.basescan.org/api?module=logs&action=getLogs&fromBlock=${startBlock}&toBlock=${currentBlock}&address=0xc4E637D37113192F4F1F060DaEbD7758De7F4131&topic0=0x3e5a874dd8f086c73bba5a860cb04972e50b6207f84cc020037d576afa6ebc13&page=1&offset=1000&apikey=${process.env.API_BASESCAN_KEY}`
    ...
    public static async getLockUNCXsushi(currentBlock: number, startBlock: number) {
        const urlLockUNCXsushi = `https://api.basescan.org/api?module=logs&action=getLogs&fromBlock=${startBlock}&toBlock=${currentBlock}&address=0xBeddF48499788607B4c2e704e9099561ab38Aae8&topic0=0x3e5a874dd8f086c73bba5a860cb04972e50b6207f84cc020037d576afa6ebc13&page=1&offset=1000&apikey=${process.env.API_BASESCAN_KEY}`
    ...
    public static async getLpAmount(currentBlock: number, pairAddress: string, deployerAddress: string) {
        const urlGetLpAmount = `https://api.basescan.org/api?module=account&action=tokentx&contractaddress=${pairAddress}&address=${deployerAddress}&page=1&offset=100&startblock=0&endblock=${currentBlock}&sort=asc&apikey=${process.env.API_BASESCAN_KEY}`
