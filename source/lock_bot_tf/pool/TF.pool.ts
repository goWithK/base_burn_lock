...
export class TFDataPool implements IDataPool {
    ...
    public get tokenSymbol(): Promise<string> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[TF.pool.tokenSymbol] Cannot get symbol of token: ${await this.contractAddress}`)
            }
    ...
    public get tokenDecimal(): Promise<number> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[TF.pool.tokenDecimal] Cannot get decimals of token: ${await this.contractAddress}`)
            }
    ...
    public get totalHolders(): Promise<number> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[TF.pool.totalHolders] Cannot get total holders of token: ${await this.contractAddress}`)
            }
    ...
    public get topHolders(): Promise<{[index: string]: any}> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[TF.pool.topHolders] Cannot get top holders of token: ${await this.contractAddress}`)
            }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[TF.pool.totalTxns] Cannot get data from DexScreener')
                }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[TF.pool.priceToken] Cannot get data from DexScreener')
                }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[TF.pool.liquidity] Cannot get data from DexScreener')
                }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[TF.pool.liveTime] Cannot get data from DexScreener')
                }
    ...
    public get deployerBalance(): Promise<number> {
        return (async () => {
            ...
            try {
                ...
                console.error(e)
                throw Error(`[TF.pool.deployerBalance] Cannot get balance of deployer: ${await this.deployerAddress}`)
            }
    ...
    public get verified(): Promise<boolean> {
        return (async () => {
            ...
            try {
                ...
                console.error(e)
                throw Error(`[TF.pool.verified] Cannot get ABI of contract: ${await this.contractAddress}`)
            }
