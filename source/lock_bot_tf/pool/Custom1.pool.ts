...
import CustomLock1_ABI from '../../../src/JSON/CustomLock1.json';
...
export class Custom1DataPool implements IDataPool {
    ...
    public constructor(transactionHash: string, mode: string = 'TF') {
    ...
    public get renounced(): Promise<boolean> {
        return (async () => {
            ...
            try {
                ...
                console.error(e)
                throw Error(`[TF.pool.renounced] Cannot get txn of address: ${await this.deployerAddress}`)
            }
    ...
    public get lockPercent(): Promise<number> {
        return (async () => {
            ...
            const lockData = await this.lockInfo;
            const lockAmount = lockData?.args[2];
            var resp: any;
    ...
    public get lockDays(): Promise<number> {
        return (async () => {
            ...
            const lockData = await this.lockInfo;
            const unlockTime = Number(lockData?.args[3]);
    ...
    public get tokenName(): Promise<string> {
        return (async () => {
            ...
            try {
                ...
                console.error(e)
                throw Error(`[TF.pool.tokenName] Cannot get name of token: ${await this.contractAddress}`)
            }
    ...
    public get tokenSymbol(): Promise<string> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[Custom1.pool.tokenSymbol] Cannot get symbol of token: ${await this.contractAddress}`)
            }
    ...
    public get tokenDecimal(): Promise<number> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[Custom1.pool.tokenDecimal] Cannot get decimals of token: ${await this.contractAddress}`)
            }
    ...
    public get totalHolders(): Promise<number> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[Custom1.pool.totalHolders] Cannot get total holders of token: ${await this.contractAddress}`)
            }
    ...
    public get topHolders(): Promise<{[index: string]: any}> {
        return (async () => {
            ...
            try{
                ...
                console.error(e)
                throw Error(`[Custom1.pool.topHolders] Cannot get top holders of token: ${await this.contractAddress}`)
            }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[Custom1.pool.totalTxns] Cannot get data from DexScreener')
                }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[Custom1.pool.priceToken] Cannot get data from DexScreener')
                }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[Custom1.pool.liquidity] Cannot get data from DexScreener')
                }
        ...
        return (async () => {
            ...
            if (!this._dexData) {
                try {
                    ...
                    console.error(e)
                    throw Error('[Custom1.pool.liveTime] Cannot get data from DexScreener')
                }
    ...
    public get deployerBalance(): Promise<number> {
        return (async () => {
            ...
            try {
                ...
                console.error(e)
                throw Error(`[Custom1.pool.deployerBalance] Cannot get balance of deployer: ${await this.deployerAddress}`)
            }
    ...
    public get verified(): Promise<boolean> {
        return (async () => {
            ...
            try {
                ...
                console.error(e)
                throw Error(`[Custom1.pool.verified] Cannot get ABI of contract: ${await this.contractAddress}`)
            }
    ...
    private async _fulfillInfoLock(mode: string): Promise<void> {
        ...
        if (mode == 'OM'){
            ...
            inter = new ethers.Interface(CustomLock1_ABI);
        }
