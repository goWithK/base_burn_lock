...
import { BotContext, BotType, IBotCommand } from '../shared/type';
import { hydrateReply } from '@grammyjs/parse-mode';
import { emojiParser } from '@grammyjs/emoji';
import { globalConfig, groupConfig, outConfig } from "../shared/config";
...
class TelegramBotFilter {
    ...
    public constructor (commandHandler: any, botToken: string) {
...
export default TelegramBotFilter;